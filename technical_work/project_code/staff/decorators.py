"""
The code from this file has been taken from https://stackoverflow.com/questions/2723842/django-message-framework-and-login-required

Its purpose is to add a new version of the login_required decorator that allows me
to send messages to the redirect login page upon failing authenitcation
"""
